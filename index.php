...
if( ! defined('ABSPATH') ) exit; //Exits if accessed directly
...
class OurWordFilterPlugin {
    ...
    function handleForm() {
        if (wp_verify_nonce( $_POST['ourNonce'], 'saveFilterWords' )) {
            ...
            <div class="updated">
                <p>Filtered Words were saved.</p>
            </div>

        <?php } else { ?>
            <div class="error">
                <p>Sorry you donot have permision to access this input. </p>
            </div>
    ...
    <div class="wrap">
        ...
        <form method="POST">
            ...
            <label for="plugin_words_to_filter"><p>Enter a <strong>comma sepreted</strong> list of word to filter.</p></label>
            <div class="word_filter__flex_container">
                <textarea name="plugin_words_to_filter" id="plugin_words_to_filter" placeholder="mean,bad,awfull"><?php echo esc_textarea(get_option('plugin_words_to_filter')) ?></textarea>
            </div>
